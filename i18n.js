...
(function () {
  var DICT = {
    ...
    '2026 年 9 月 25 日': ['2026 年 9 月 25 日', '2026 年 9 月 25 日', 'Sep 25, 2026'],
    '2026 年 9 月 25 日 · 中国': ['2026 年 9 月 25 日 · 中国', '2026 年 9 月 25 日 · 中國', 'Sep 25, 2026 · China'],
    '关于商店接入支付系统 - Caelus Studio 新闻中心': ['关于商店接入支付系统 - Caelus Studio 新闻中心', '關於商店接入支付系統 - Caelus Studio 新聞中心', 'Shop Payment System Integration - Caelus Studio News'],
    '关于商店接入支付系统': ['关于商店接入支付系统', '關於商店接入支付系統', 'About the Shop Payment System'],
    '周边商店正在接入支付系统，届时支持支付宝与微信支付；接入期间全站页面将进行维护更新。': ['周边商店正在接入支付系统，届时支持支付宝与微信支付；接入期间全站页面将进行维护更新。', '周邊商店正在接入支付系統，屆時支援支付寶與微信支付；接入期間全站頁面將進行維護更新。', 'The merch store is getting a payment system. Once live, Alipay and WeChat Pay will be supported; all shop pages will undergo maintenance during the rollout.'],
    'Caelus Studio正在为周边商店接入支付系统，届时您可以通过以下支付方式支付': ['Caelus Studio正在为周边商店接入支付系统，届时您可以通过以下支付方式支付', 'Caelus Studio正在為周邊商店接入支付系統，屆時您可以通過以下支付方式支付', 'Caelus Studio is integrating a payment system into the merch store. Once live, you will be able to pay using the following methods'],
    '1.支付宝': ['1.支付宝', '1.支付寶', '1. Alipay'],
    '2.微信': ['2.微信', '2.微信', '2. WeChat Pay'],
    '在接入支付系统期间，我们将会对商店所有页面进行维护更新，可能会持续一段时间，很抱歉给各位带来的不便': ['在接入支付系统期间，我们将会对商店所有页面进行维护更新，可能会持续一段时间，很抱歉给各位带来的不便', '在接入支付系統期間，我們將會對商店所有頁面進行維護更新，可能會持續一段時間，很抱歉給各位帶來的不便', 'While the payment system is being integrated, we will be performing maintenance and updates across all shop pages. This may take some time — sorry for the inconvenience.'],
    '注：此为不肯定更新，可能会撤销此更新': ['注：此为不肯定更新，可能会撤销此更新', '註：此為不肯定更新，可能會撤銷此更新', 'Note: this update is not confirmed and may be reverted.'],
    '周边商店正在接入支付系统，届时支持支付宝与微信支付。接入期间商店所有页面将进行维护更新，可能持续一段时间。': ['周边商店正在接入支付系统，届时支持支付宝与微信支付。接入期间商店所有页面将进行维护更新，可能持续一段时间。', '周邊商店正在接入支付系統，屆時支援支付寶與微信支付。接入期間商店所有頁面將進行維護更新，可能持續一段時間。', 'The merch store is getting a payment system — Alipay and WeChat Pay will be supported. All shop pages will undergo maintenance during the rollout, which may take some time.'],
